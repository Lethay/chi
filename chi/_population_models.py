...
def is_heterogeneous(population_model):
    return isinstance(population_model, (HeterogeneousModel, KolmogorovSmirnovPopulationModel))
...
class KolmogorovSmirnovPopulationModel(PopulationModel):
    ...
    def _compute_log_likelihood(
            parameters, model_cdf, observation_cdf):  # pragma: no cover
        """
        Calculates the log-likelihood using numba speed up.
        """
        # Get parameters
    ...
    def _compute_sensitivities(
            parameters, model_cdf, model_sensitivities,
    ...
    time_key="time", biom_key="biomarker", meas_key="bm_value"):
        ...
        return self._compute_log_likelihood(
            parameters, est_cdf_heights, self._obs_cdf_heights)
    ...
    def sample(self, parameters, model_outputs, n_samples=None, seed=None,
    time_key="time", biom_key="biomarker", meas_key="bm_value"):
        """
